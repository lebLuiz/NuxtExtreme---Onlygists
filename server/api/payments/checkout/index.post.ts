...
export default defineEventHandler(async (event) => {
    ...
    const body = await zh.useSafeValidatedBody(
        ...
        z.object({
            username: z.string(),
            gistId: z.string(),
            // @TODO: não é interessante passar o `price` como atributo da request, pois pode ser passado qualquer valor que o client desejar. Analisar implementação de outra forma.
            price: z.string(),
        }),
    )
