    ...
    <div class="flex flex-col gap-4">
        <div class="flex flex-col md:flex-row gap-2">
            <div class="flex flex-col gap-2 flex-1">
                ...
                <InputText id="name" placeholder="Igor Halfed" v-model="user.name" />
                <small v-if="props.errors?.name">{{ props.errors?.name._errors[0] }}</small>
            </div>

            <div class="flex flex-col gap-2 flex-1">
                <label for="site">Site</label>
                <InputText id="site" placeholder="luiz_b.com" v-model="user.site" />
        ...
        <div class="flex flex-col md:flex-row gap-2">
            <div class="flex flex-col gap-2 flex-1">
                ...
                <InputText id="bio" placeholder="Software Enginner" v-model="user.bio" />
                <small v-if="props.errors?.bio">{{ props.errors?.bio._errors[0] }}</small>
            </div>

            <div class="flex flex-col gap-2 flex-1">
                <label for="phone">Telefone</label>
                <InputText id="phone" placeholder="(99) 9 99999-9999" v-model="user.phone" />
